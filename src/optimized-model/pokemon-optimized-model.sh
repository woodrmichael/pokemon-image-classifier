...
command="horovodrun -np 4 -H localhost:4 python optimized-model.py --data /home/woodm/CSC2611/pokemon-image-classifier/stratified-data --batch_size 32 --epochs 5 --main_dir /home/woodm/CSC2611/pokemon-image-classifier/src/optimized-model --augment_data false --fine_tune false"
