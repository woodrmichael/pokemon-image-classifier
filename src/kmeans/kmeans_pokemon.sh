...
command="horovodrun -np 4 -H localhost:4 python pokemon_model.py --data /home/woodm/CSC2611/pokemon-image-classifier/data --batch_size 32 --epochs 5 --main_dir /home/woodm/CSC2611/pokemon-image-classifier --augment_data true --fine_tune false"
